...
const Support = () => (
    <div>
        ...
        <Box
            className="main-error-wrapper wrapper-1 page page-h"
		...
		c0.058-0.425,0.097-0.851,0.117-1.275C37.271,16.145,39,18.228,39,20.792C39,23.664,36.732,26,33.945,26z"/>
            ...
            <p className="lead">
                Chúng tôi luôn sẵn sàng giúp đỡ bạn. Nếu bạn gặp vấn đề hoặc có câu hỏi, vui lòng liên hệ với bộ phận hỗ trợ của chúng tôi.
            </p>
            <div>
                Gửi email cho chúng tôi tại địa chỉ: <StringWrapper text='gofarm.service@gmail.com' />
            </div>
        </Box>
    </div>
