...
function UpdatePolicy({
    ...
    const handleUpdate = useCallback((key: keyof PolicyItem, value: string) => {
        setData(prev => ({
            ...prev,
            [key]: value
        }));
    ...
    const validate = (policy: PolicyItem) => {
        const hasOneNotValid = !policy.name || !policy.description
...
export default memo(UpdatePolicy);